...
class Blackjack:
    ...
    def game(self):
        ...
        while True:
            ...
            self.player_hand.append(("Clubs", 7, "7"))
            self.player_hand.append(("Spades", 7, "7"))
            ...
            while self.game_state is True:
                ...
                if self.player_isSplit is True and (self.player_count > 21 and self.player_secondStand is True) or (
                        self.player_firstStand is True and self.player_secondCount > 21):
                    self.game_state = False
            ...
            while self.game_state is False:
                if self.player_isSplit is False:
                    ...
                    print(f"PLAYER FIRST HAND: {self.player_count}")
                    print(f"PLAYER SECOND HAND: {self.player_secondCount}")
                    print(f"DEALER'S HAND: {self.dealer_count}")
                    if self.dealer_count == self.player_count == self.player_secondStand:
                        ...
                        self.pot = 0
                        break
                    elif (self.player_count == self.dealer_count and self.player_secondCount < self.dealer_count) or (self.player_count < self.dealer_count and self.player_secondCount == self.dealer_count):
    ...
    def player_round(self):
        ...
        if self.player_isSplit is False:
            ...
            if self.player_count > 21 and self.player_secondCount > 21:
                self.player_isBust()
    ...
    def current_action(self):
        ...
        if self.turn_count == 1 and self.player_isSplit is False and self.player_hand[0][1] == self.player_hand[1][1]:
            print("[3] Split")

        if self.turn_count == 1 and self.player_isSplit is False:
            print("[4] Double-down")
